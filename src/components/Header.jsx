        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            >
              ...
              >
                {/* <FiGlobe className="text-xl text-[#00BCFF]" /> */}
                <ReactCountryFlag
          ...
          >
            <div className="container mx-auto px-4 py-6">
              ...
              <button
                ...
                className="w-full mt-8 px-6 py-4 bg-[#00BCFF] text-white rounded-xl text-xl font-medium flex items-center justify-center space-x-3 hover:bg-blue-600 transition-colors duration-300"
              >
