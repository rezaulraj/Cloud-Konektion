...
// <div class="calendly-inline-widget" data-url="https://calendly.com/cloud-conektion-qwikhr/30min" style="min-width:320px;height:700px;"></div>
            ...
            >
              ...
              {loading && (
                <div className="flex-1 flex items-center justify-center">
                  <div className="animate-spin rounded-full h-20 w-20 border-t-4 border-[#1A9695] border-opacity-75"></div>
                </div>
              )}
